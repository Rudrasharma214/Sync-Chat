        ...
        <section className="mx-auto max-w-7xl px-6 pb-16 sm:px-10 lg:px-14">
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="theme-border theme-surface rounded-2xl border p-6 shadow-sm shadow-slate-900/10">
              ...
              <p className="theme-muted mt-1 text-sm">Instant message delivery with WebSockets.</p>
            </div>
            ...
            <div className="theme-border theme-surface rounded-2xl border p-6 shadow-sm shadow-slate-900/10">
              ...
              <p className="theme-muted mt-1 text-sm">Minimal UI focused on conversations.</p>
            </div>
          </div>
        </section>
