...
export const getNotificationPreferences = async () => {
  try {
    ...
    logger.error(
      "Get notification preferences API call failed",
      error.response?.data,
...
export const updateNotificationPreferences = async (payload) => {
  try {
    ...
    logger.info(
      "Update notification preferences API call successful",
      null,
      "NotificationServices"
    );
    return {
    ...
    logger.error(
      "Update notification preferences API call failed",
      error.response?.data,
      "NotificationServices"
    );
    return {
...
export const toggleNotifications = async (enabled) => {
  try {
    ...
    logger.error(
      "Toggle notifications API call failed",
      error.response?.data,
      "NotificationServices"
    );
    return {
...
export const getUnreadSummary = async (limit = 5) => {
  try {
    ...
    logger.error(
      "Get unread summary API call failed",
      error.response?.data,
      "NotificationServices"
    );
    return {
