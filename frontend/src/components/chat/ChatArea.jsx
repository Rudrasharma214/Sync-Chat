...
import { ArrowLeft, Mic, MoreVertical, Paperclip, Phone, Search, Send, Smile, Video, X } from "lucide-react";
    ...
    return (
        <section className="theme-surface relative flex h-full min-w-0 flex-1 flex-col">
            ...
            >
                ...
                <aside
                    className={`absolute right-0 top-0 h-full w-full max-w-[360px] border-l theme-border bg-[var(--surface)] shadow-2xl transition sm:w-[320px] ${showDetails
                ...
                >
                    ...
                    <div className="h-full overflow-y-auto px-4 py-4">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-xs text-amber-500">{activeConversation.online ? "Online" : "Offline"}</p>
                        </div>
                        ...
                        <div className="theme-border mt-3 rounded-2xl border p-3">
                            <div className="flex items-center justify-between">
                                ...
                                <button type="button" className="text-xs font-semibold text-amber-500">View all</button>
                            </div>
